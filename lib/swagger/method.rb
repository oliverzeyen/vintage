...
module Vintage
  module Grape
    class Method
      ...
      def new_operation
        @operation = Vintage::Data::Operation.new
      ...
      def operation_responses
        @operation.responses = Vintage::Data::Responses.new
        ...
        (@route_settings.errors || {}).each do |code, response|
          ...
          @operation.responses.add_response(code, Vintage::Data::Response.parse(error_response))
        end
        ...
        if @route_settings.response.present? && @route_settings.response[:entity].present?
          ...
          type = Vintage::Grape::Type.new(@route_settings.response[:entity].to_s)
          ...
          @operation.responses.add_response('200', Vintage::Data::Response.parse(rainbow_response))
        end

        @operation.responses.add_response('default', Vintage::Data::Response.parse({ 'description' => 'Unexpected error' }))
      end

      def operation_security
        if @route_settings.scopes # grape extensions
          security = Vintage::Data::SecurityRequirement.new
      ...
      def query_params
        @route_settings.params.each do |parameter|
          ...
          swag_param = Vintage::Data::Parameter.from_grape(parameter)
      ...
      def body_params
        ...
        root_param = Vintage::Data::Parameter.parse({ 'name' => body_name,
                                                      'in' => 'body',
        ...
        @route_settings.params.each do |parameter|
          ...
          if param_name.scan(/[0-9a-zA-Z_]+/).count == 1
            ...
            converted_param = Vintage::Grape::Param.new(param_value)
      ...
      def schema_with_subobjects(schema, param_name, parameter)
        ...
        converted_param = Vintage::Grape::Param.new(parameter)
